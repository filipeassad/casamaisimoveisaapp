...
public class PutHttpComHeaderAsyncTask extends AsyncTask<String, String, JSONObject> {
    ...
    public PutHttpComHeaderAsyncTask(Context contexto, JSONObject jsonObject, HttpResponseInterface httpResponseInterface, String rotaApi) {
